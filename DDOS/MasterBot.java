                ...
                if(port1 > 1024) {
                    ...
                    while (true) {
                       ...
                       // else{
                            //Inserted
                            ...
                            else if((cmnd[0].equalsIgnoreCase("connect")) && cmnd.length > 4) {
                                ...
                                if(cmnd[1].equalsIgnoreCase("all")){
                                    ...
                                    for(int y = 0; y< count; y++){
                                        SocketConnection.connectall(Objarr[y].getX(), trgtPNo, webName, numbr);
                                    }
                                }
                                else
                                    //Ip_addr = "127.0.0.1";
                                    if(cmnd[1].equalsIgnoreCase(Ip_addr)){
                                        ...
                                        int trgtPNo = Integer.parseInt(portNoTrgt);
                                        int numbr = Integer.parseInt(connections);
                                        SocketConnection.connectall(Objarr[cnt].getX(), trgtPNo, webName, numbr);
                                        cnt++;
                                    }
                                    else {
                                        ...
                                        if(slName.equalsIgnoreCase("slave") && (num < count)){
                                            ...
                                            for(int d = 0; d <count; d++){
                                                if (cmnd[1].equalsIgnoreCase(Objarr[d].getName())){
                                                    ...
                                                    SocketConnection.connectall(slavePortNo, trgtPNo, webName, numbr);
                                                }
                            ...
                            //
                                ...
                                if (cmnd.length < 4){
                                    System.out.println("The command is not correct. Missing Target Ip or Port no ");
                                    System.out.println("-1");
                                    System.exit(-1);
                                }
                                else
                                ...
                                if(cmnd[0].equalsIgnoreCase("disconnect")){
                                    ...
                                    if (cmnd.length < 3){
                                        System.out.println("The command is not correct. Missing Target Ip ");
                                        System.out.println("-1");
                                        System.exit(-1);
                                    }
                                    else
